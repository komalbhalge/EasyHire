...
class SplashActivity : AppCompatActivity() {
    ...
    private fun getCandidateList(): ArrayList<CandidateData> {
        ...
        items.add(CandidateData("0", CandidateStatus.NONE.ordinal, "Kiren Shah", "I am an Android Developer with 4 years of experience I am an Android Developer with 4 years of experience I am an Android Developer with 4 years of experience", "https://cdn3.vectorstock.com/i/1000x1000/44/37/cute-face-little-girl-ballerina-cartoon-character-vector-18274437.jpg"))
        items.add(CandidateData("0", CandidateStatus.NONE.ordinal, "Tejal Shah", "I am an Android Developer with 9 years of experience", "https://cdn2.vectorstock.com/i/1000x1000/19/91/cute-cartoon-girl-laugh-face-expression-vector-15161991.jpg"))
        items.add(CandidateData("0", CandidateStatus.NONE.ordinal, "Jon Zimsky", "I am an Android Developer with 1 years of experience", "https://t3.ftcdn.net/jpg/01/38/22/38/500_F_138223845_1sz6vri7VLHeqFRjjP4JOvxdglvcLz9C.jpg"))
        ...
        items.add(CandidateData("0", CandidateStatus.NONE.ordinal, "Kiren Shah", "I am an Android Developer with 4 years of experience", "http://www.melisendevector.com/images/Image/Cartoon-Black-Boy---Wavy-Hairstyle.jpg"))
        items.add(CandidateData("0", CandidateStatus.SHORTLISTED.ordinal, "Ronak Shah", "I am an Android Developer with 6 years of experience", "https://cdn1.vectorstock.com/i/1000x1000/40/25/cartoon-character-face-boy-children-vector-14814025.jpg"))
        return items
    }
        ...
        val messageListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                if (dataSnapshot.exists()) {
                    val message = dataSnapshot.getValue(CandidateData::class.java)
    ...
    private fun writeNewCandidate() {
        ...
        startActivity(Intent(this@SplashActivity, HomeActivity::class.java))
        finish()
        /*} else {val editor = sharedPref!!.edit()
